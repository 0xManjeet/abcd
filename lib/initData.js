...
router.get('/', async (req, res) => {
    ...
    let map_for_name_of_boxed_options = new Map();
    map_for_name_of_boxed_options.set(Buffer.from(JSON.stringify(maleOption)).toString('base64'), {
        actionData: "qid_3",
        actionType: enums_1.ActionTypes.NewQuestion
    });
    map_for_name_of_boxed_options.set(Buffer.from(JSON.stringify(femaleOption)).toString('base64'), {
        actionData: "qid_3",
        actionType: enums_1.ActionTypes.NewQuestion
    });
    map_for_name_of_boxed_options.set(Buffer.from(JSON.stringify(otherGenderOption)).toString('base64'), {
        actionData: "qid_3",
        actionType: enums_1.ActionTypes.NewQuestion
    });
    let q2 = {
        ...
        answer: {
            answerType: enums_1.AnswerTypes.BoxedOptions,
            data: Object.fromEntries(map_for_name_of_boxed_options)
        }
    };
    let q3 = {
        qID: "qid_3",
